...
def populate_add_faculty_gui(new_win):
    ...
    Label(new_win, text='First Name:', foreground='green').grid(row=1, column=0, padx=15, pady=5)
    Label(new_win, text='Last Name:', foreground='green').grid(row=2, column=0, padx=15, pady=5)
    Label(new_win, text='DOB:', foreground='green').grid(row=3, column=0, padx=15, pady=5)
    Label(new_win, text='Dept:', foreground='green').grid(row=4, column=0, padx=15, pady=5)
    Label(new_win, text='Password:', foreground='green').grid(row=5, column=0, padx=15, pady=5)
    Label(new_win, text='Fav colour:', foreground='green').grid(row=6, column=0, padx=15, pady=5)

    e_ID = Entry(new_win, width=25, textvariable=ID)
    e_ID.grid(row=0, column=1, padx=15)
    e_first_name = Entry(new_win, width=25, textvariable=FirstName)
    e_first_name.grid(row=1, column=1, padx=15)
    e_last_name = Entry(new_win, width=25, textvariable=LastName)
    e_last_name.grid(row=2, column=1, padx=15)
    e_DOB = Entry(new_win, width=25, textvariable=DOB)
    e_DOB.grid(row=3, column=1, padx=15)
    e_dept = Entry(new_win, width=25, textvariable=Dept)
    e_dept.grid(row=4, column=1, padx=15)
    e_Pwd = Entry(new_win, width=25, textvariable=Pwd)
    e_Pwd.grid(row=5, column=1, padx=1)
    e_colour = Entry(new_win, width=25, textvariable=Colour)
    e_colour.grid(row=6, column=1, padx=15)

    Button(new_win, text='Submit', command=new_win.destroy).grid(row=7, column=0)
    Button(new_win, text='Cancel', command=new_win.destroy).grid(row=7, column=1)
    new_win.grab_set()
    new_win.wait_window()

    return ID.get(), FirstName.get(), LastName.get(), DOB.get(), Dept.get(), Pwd.get(), Colour.get()
